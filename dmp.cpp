...
void dmp_init(void) {
	...
	mpu.setXAccelOffset(-4989); // 1688 factory default for my test chip
	mpu.setYAccelOffset(1093); // 1688 factory default for my test chip
	mpu.setZAccelOffset(1211); // 1688 factory default for my test chip
